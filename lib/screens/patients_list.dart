              ...
              child: Row(
                children: [
                  ...
                  CustomRadioButton(
                    ...
                    radioInactiveColor: Colors.transparent,
                    isRadioSelected: selectedFilter == "Critical Condition",
                    onTapRadio: () =>
                        setState(() => selectedFilter == "Critical Condition"),
                  ),
                ],
              ),
            ),
                ...
                (index) {
                  return Padding(
                    ...
                    child: CustomPatientCard(
                      iscritical: Random().nextBool(),
                      patientName: "Alexander Muasya",
                      doctorName: "Miranda Bayleigh",
                      department: "Oncology",
                      onTapPatientCard: () {},
                    ),
                  );
